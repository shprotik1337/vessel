...
Скачай установщик `Vessel_1.2.0_x64-setup.exe` из [Releases](https://github.com/shprotik1337/vessel/releases/latest) и запусти — NSIS-инсталлятор (~14 МБ) сделает всё сам. Инсталлятор включает всё нужное: поиск, плеер, импорт плейлистов и лайков.
...
Готовый installer появится в `target/release/bundle/nsis/Vessel_1.2.0_x64-setup.exe`.

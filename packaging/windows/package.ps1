...
$stagePath = Join-Path $outputPath "vessel-windows-x86_64"
$archivePath = Join-Path $outputPath "vessel-windows-x86_64.zip"
$manifestPath = Join-Path $outputPath "vessel.json"
...
Copy-Item -LiteralPath $binaryPath -Destination (Join-Path $stagePath "vessel.exe")
...
$releaseUrl = "https://github.com/Jselyx/vessel-tui/releases/download/v$Version/vessel-windows-x86_64.zip"
$manifest = [ordered]@{
    version = $Version
